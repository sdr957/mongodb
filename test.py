...
data={
    'name':'Nikhil sardar',
    'email_id':'sardarnikhil957@gmail.com',
    'subject':['machine learning','artifical inteligence','data science']
}
data1=[
    {'companyName': 'iNeuron',
...
dada2= [{"packetType": "D",
          "data": {"checkEngineLightFlag": "F", "batteryVoltageStableTime": 0, "batteryVoltageStable": "0",
                   ...
                   "gatewayTs": 1515613306592, "diagnosticTroubleCodeData": [123],
